//----------- IMPORTAÇÃO DA BIBLIOTECA DE FORMATAÇÃO DE NÚMEROS DECIMAIS EM JAVA ---------- //
...
public class PostoCombustivel {
	...
	//----- UM PARA FORMATAÇÃO DE PRECO EM BRL E OUTRO PARA QUANTIDADES COM PONTO FLUTUANTE COM PRECISÃO DE DUAS CASAS DECIMAIS ------//
  ...
  //------- MÉTODOS DA CLASSE POSTO_COMBUSTÍVEL ------//
    ...
    public String Abastecer (String tipoCombustivel, double quantidadeCombustivel) {
        ...
        if ((!tipoCombustivel.equals("GASOLINA")) && (!tipoCombustivel.equals("ALCOOL")) && (!tipoCombustivel.equals("ÁLCOOL"))) {
   ...
   public String Pagamento (String formaPagamento) {
       ...
       if ((!formaPagamento.equals("DINHEIRO")) && (!formaPagamento.equals("CARTÃO")) && (!formaPagamento.equals("CARTAO"))) {
   ...
   public void ResumoAbastecimento () {
       ...
       System.out.println("Combustível abastecido: " + this.tipoCombustivel);
